...
| **`@mindfiredigital/adac-validator`**  | Validation Layer.               | Formally defines the ADAC specification using JSON Schema.                      |
...
3.  **Core** supports `elk`, `custom`, and opt-in `orthogonal`/`tsm` layout strategies.
